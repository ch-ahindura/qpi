...
```bash
# macOS (replace 0.3.0 with the version you wish to install)
curl -LO https://github.com/sopherapps/qpi/releases/download/v0.3.0/qpi-0.3.0-darwin-amd64
chmod +x qpi-0.3.0-darwin-amd64 && mv qpi-0.3.0-darwin-amd64 qpi

# Linux (standalone binary)
curl -L https://github.com/sopherapps/qpi/releases/download/v0.3.0/qpi-0.3.0-linux-amd64.tar.gz | tar -xz
...
```bash
wget https://github.com/sopherapps/qpi/releases/download/v0.3.0/qpi_0.3.0_amd64.deb
sudo apt install ./qpi_0.3.0_amd64.deb
```
